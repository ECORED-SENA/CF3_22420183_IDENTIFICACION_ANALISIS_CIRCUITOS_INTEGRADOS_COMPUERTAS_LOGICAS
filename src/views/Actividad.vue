      ...
      preguntas: [
        {
          id: 1,
          texto:
            'Las compuertas lógicas son elementos básicos de los circuitos digitales.',
        ...
        {
          id: 3,
          texto: 'Los circuitos combinacionales no almacenan información.',
        ...
        },
        {
          id: 5,
          texto:
            'Los circuitos integrados contienen varias compuertas lógicas.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero.', esCorrecta: true },
        ...
        },
        {
          id: 7,
          texto:
            'La tabla de verdad muestra todas las posibles combinaciones de entradas y salidas.',
          imagen: require('@/assets/actividad/imagen3.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero.', esCorrecta: true },
        ...
        {
          id: 9,
          texto: 'Los circuitos secuenciales almacenan información.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero.', esCorrecta: true },
